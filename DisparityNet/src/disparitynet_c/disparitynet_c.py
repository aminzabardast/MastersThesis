...
class DisparityNetC(BaseNetwork):
    ...
    def __init__(self, epochs=1, name_prefix='c'):
    ...
    def model(self, *args, **kwargs):
        ...
        deconv0 = Conv2DTranspose(filters=2, kernel_size=(5, 5), strides=2, padding='same', activation='relu', name='{}/deconv0'.format(self.name_prefix))(deconv1_concat)  # Resulting Dimensions: 512x512x1
        return deconv0
